    ...
    <body id="body">
        ...
        <img class="hiking" src="img/hiking.png">
          <div id="hikingText">
            ...
            <a href="shopPage.php"> <input class="bootButton" type="button" value="Boots"></a>
          </div>
        ...
        <img class="running" src="img/running.png">
          <div id="runningText">
            ...
            <a href="shopPage.php"> <input class="athleticButton" type="button" value="Athletic"></a>
          </div>
          ...
          <img class="relaxing" src="img/relaxing.png">
            <div id="comforText">
              ...
              <a href="shopPage.php"> <input class="comfortButton" type="button" value="Comfort"></a>
            </div>
